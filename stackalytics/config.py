...
PROCESSOR_OPTS = [
    cfg.StrOpt('default-data-uri',
               ...
               help='URI for default data. Instead of URI, a local file can '
                    'be used with the prefix "file://". For example, '
...
ALL_OPTS = CONNECTION_OPTS + PROCESSOR_OPTS + DASHBOARD_OPTS
