...
class PersistentStorage(object):
    ...
    def sync(self, default_data_file_name):
        ...
        self._build_index(default_data['domains'], 'domain',
                          self.get_domains, self.insert_domain)
...
class MongodbStorage(PersistentStorage):
    def __init__(self, uri):
        ...
        self.mongo.domains.create_index([("domain", pymongo.ASCENDING)])
    ...
    def get_domains(self, **criteria):
        return self.mongo.domains.find(criteria)

    def insert_domain(self, domain):
        self.mongo.domains.insert(domain)
