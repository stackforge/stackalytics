...
class TestAPIReleases(test_api.TestAPI):
    ...
    def test_releases(self):
        with test_api.make_runtime_storage(
                {'releases': [
                    {'release_name': 'prehistory', 'end_date': 1365033600, 'project': 'nova'},
                    {'release_name': 'havana', 'end_date': 1381968000, 'project': 'glance'},
                    {'release_name': 'icehouse', 'end_date': 1397692800, 'project': 'nova-cli'}],
                 'project_types': [
                     {'id': 'all', 'title': 'All',
            ...
            self.assertIn({'project': 'nova-cli', 'id': 'icehouse', 'text': 'Icehouse'}, releases)
