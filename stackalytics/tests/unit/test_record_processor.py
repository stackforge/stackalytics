...
class TestRecordProcessor(testtools.TestCase):
    ...
    def test_process_email_then_review(self):
        ...
        self.assertEqual(user, user_processor.load_user(
            record_processor_inst.runtime_storage_inst,
            gerrit_id=('review.openstack.org', ['john_doe'])))
    ...
    def test_process_reviews_two_gerrits(self):
        ...
        self.assertEqual(user, user_processor.load_user(
            runtime_storage_inst,
            gerrit_id=('review.gerrithub.io', ['john_doe'])))
    ...
    def test_process_reviews_two_ids_in_one_gerrit(self):
        ...
        self.assertEqual(user, user_processor.load_user(
            runtime_storage_inst,
            gerrit_id=('review.openstack.org', ['johnathan_doe'])))
        self.assertEqual(user, user_processor.load_user(
            runtime_storage_inst,
            gerrit_id=('review.gerrithub.io', ['johnathan_doe'])))
