...
class CachedMemoryStorage(MemoryStorage):
    ...
    def _save_record(self, record):
        ...
        self._add_to_index(self.record_types_index, record, 'record_type')
    ...
    def get_commit_ids(self):
        return set(self.record_types_index['commit'])  # return copy

    def get_review_ids(self):
        return set(self.record_types_index['review'])  # return copy
